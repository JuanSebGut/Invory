...
- **Archivos Claves de Migración:** 
  ...
  - `02_parametros_sistema.sql`: Crea la tabla `parametros_sistema` y siembra 3 parámetros iniciales: `dias_expiracion_alertas`, `max_intentos_login`, `tiempo_bloqueo_minutos`.
  ...
  - `05_mejoras_invory.sql`: Nuevos módulos (Unidades de medida, Facturación, Fiados y Clientes). Además, siembra 3 parámetros adicionales en `parametros_sistema`: `dias_aviso_fiado`, `consecutivo_factura_actual`, `prefijo_factura`.
